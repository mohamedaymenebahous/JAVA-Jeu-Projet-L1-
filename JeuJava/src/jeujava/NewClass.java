...
public class NewClass {
    ...
    public void setPlateau(Plateau2 p) {
        this.plt = p;
    } 
            ...
            for(int i = 0; i < this.lj.getNbJoueurs(); i++) {
                ...
                do {
                    try {
                        ...
                        if(this.getCase1prime().equals(this.combinaisonList.get(j).getCase1())) {
                            pw.println("Cette case a été déja dévoilée");
                        } else {
                            j++;
                        }
                ...
                } while(this.getCase1prime().equals(this.combinaisonList.get(j).getCase1()));
                do {
                    try {
                        this.choixDeuxiemeCase();
                        if(this.getCase2prime().equals(this.combinaisonList.get(j).getCase1())) {
                            pw.println("Cette case a été déja dévoilée");
                        } else {
                            j++;
                        } 
                ...
                } while(this.getCase2prime().equals(this.combinaisonList.get(j).getCase1()));
    ...
    public void verificationHyp(int i) {
        ...
        if(this.getReponseHyp().equals("oui") || this.getReponseHyp().equals("Oui") || this.getReponseHyp().equals("OUI")) {
    ...
    public NewClass(Plateau2 p, LesJoueurs l) {
        this.setPlateau(p);
...
pw.println("Indice première case : " + this.getPlateau().getIndiceSomme().getSomme(this.getCase1(), this.getCase2()));
pw.println("Indice deuxième case : " + this.getPlateau().getIndiceProduit().getProduit(this.getCase1(), this.getCase2()));
